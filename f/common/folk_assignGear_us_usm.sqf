...
_rifle = "RH_m16a1"; _riflemag = "20Rnd_556x45_Stanag";																						// Standard Riflemen (Spotter, HMG Assistant Gunner, MMG Assistant Gunner, Assistant Automatic Rifleman, MAT Assistant Gunner, HAT Assistant Gunner, MTR Assistant Gunner, Rifleman)

_carbine = "RH_m16a1"; _carbinemag = "20Rnd_556x45_Stanag"; 																					// Standard Carabineer (Medic, HMG Gunner, Rifleman (AT), Rifleman (AA), MAT Gunner, HAT Gunner, MTR Gunner, Carabineer)
...
_glrifle = "RH_m16a1gl"; _glriflemag = "20Rnd_556x45_Stanag"; _glmag = "1Rnd_HE_M203";														// Rifle with GL and HE grenades (CO, DC, FTLs)
...
_bagmedium = "TK_ALICE_Pack_EP1";		// 8+ slots																							// Backpack for assistant gunners (AAR, AMMG, AMAT, AHAT), so that they don't have to drop ammo themselves
...
_AR = "M60A4_EP1"; _ARmag = "100Rnd_556x45_M249";																							// Automatic Rifleman
...
_MAT = "M47Launcher_EP1"; _MATmag1 = "Dragon_EP1"; _MATmag2 = "MDragon_EP1";																			// Medium AT
