...
_smg = "ukf_L85A2"; _smgmag = "30Rnd_556x45_Stanag";																									// Standard Submachine Gun/Personal Defence Weapon (Vehicle Crew, Aircraft Pilot, Submachinegunner)
...
_pistol = "RH_p226"; _pistolmag = "RH_15Rnd_9x19_usp";																								// Pistols (CO, DC, Automatic Rifleman, Medium MG Gunner)
...
_baglarge =  "BAF_AssaultPack_RifleAmmo"; 		// 12+ slots
...
_AR = "ukf_lmg"; _ARmag = "100Rnd_556x45_M249";																						// Automatic Rifleman
