// F2 - Folk Assign Gear Script - TK Local Guerilla (GUE) Equipment
...
_rifle = "RH_ak47"; _riflemag = "30Rnd_762x39_AK47";																						// Standard Riflemen (Spotter, HMG Assistant Gunner, MMG Assistant Gunner, Assistant Automatic Rifleman, MAT Assistant Gunner, HAT Assistant Gunner, MTR Assistant Gunner, Rifleman)

_carbine = "RH_ak47"; _carbinemag = "30Rnd_762x39_AK47"; 																						// Standard Carabineer (Medic, HMG Gunner, Rifleman (AT), Rifleman (AA), MAT Gunner, HAT Gunner, MTR Gunner, Carabineer)

_smg = "RH_mac10"; _smgmag = "RH_9mm_32RND_Mag";																								// Standard Submachine Gun/Personal Defence Weapon (Vehicle Crew, Aircraft Pilot, Submachinegunner)

_glrifle = "RH_ak47gl"; _glriflemag = "30Rnd_762x39_AK47"; _glmag = "1Rnd_HE_GP25";															// Rifle with GL and HE grenades (CO, DC, FTLs)
...
_AR = "RH_rpk47"; _ARmag = "RH_75Rnd_762x39_mag";																								// Automatic Rifleman
